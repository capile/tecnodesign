...
CREATE TABLE IF NOT EXISTS `tdz_contents_display_version` (
  ...
  INDEX `fk_tdz_contents_template_version_tdz_contents_version1_idx` (`content` ASC, `version` ASC),
...
-- Table `tdz_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tdz_users` ;
...
CREATE TABLE IF NOT EXISTS `tdz_users` (
  ...
  `details` TEXT NULL COMMENT 'serializable: yaml',
  `created` DATETIME NOT NULL COMMENT 'timestampable: before-insert',
  `updated` DATETIME NOT NULL COMMENT 'timestampable',
  `expired` DATETIME NULL COMMENT 'soft-delete',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `login_idx` (`login` ASC))
ENGINE = InnoDB
COMMENT = 'className: Tecnodesign_Studio_User';


-- -----------------------------------------------------
-- Table `tdz_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tdz_groups` ;
...
CREATE TABLE IF NOT EXISTS `tdz_groups` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'className: Tecnodesign_Studio_Group';


-- -----------------------------------------------------
-- Table `tdz_credentials`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tdz_credentials` ;
...
CREATE TABLE IF NOT EXISTS `tdz_credentials` (
  ...
  CONSTRAINT `fk_tdz_credentials_tdz_groups`
    ...
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'className: Tecnodesign_Studio_Credential';
...
CREATE TABLE IF NOT EXISTS `studio` (
  ...
  PRIMARY KEY (`uid`))
ENGINE = InnoDB
COMMENT = 'className: Tecnodesign_Studio_Config';
