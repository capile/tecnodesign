...
$f = __FILE__;
$tdz = false;
// on linux, it should be using symbolic links
if(strpos($f, '/src/Tecnodesign')) {
    $tdz = substr($f, 0, strpos($f, '/src/Tecnodesign')).'/tdz.php';
} else if(isset($_SERVER['tecnodz_dir'])) {
    $tdz = $_SERVER['tecnodz_dir'].'/lib/vendor/tecnodesign/tdz.php';
}
if($tdz) require_once $tdz;
tdz::cacheControl('public', 86700);
