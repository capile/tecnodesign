if(typeof(window.tdz)=='undefined') window.tdz={'started':true, 'exec':{} };
(function(tdz){
tdz.$=jQuery;
tdz.updated={};
...
tdz.tinymce=function(){
     ...
     */
    var lang=(tdz.language.search(/^[a-z][a-z]_[A-Z][A-Z]$/)>-1)?(tdz.language.substring(0,2)):('en');
