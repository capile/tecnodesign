<?php
/**
 * Tecnodesign_Estudio_Credential table description
 *
 * PHP version 5.3
 *
 * @category  Model
 ...
 */
class Tecnodesign_Estudio_Credential extends Tecnodesign_Model
{
    /**
    ...
    public static $schema = array (
      ...
      'className' => 'Tecnodesign_Estudio_Credential',
      'columns' => array (
      ...
      'relations' => array (
        'Group' => array ( 'local' => 'groupid', 'foreign' => 'id', 'type' => 'one', 'className' => 'Tecnodesign_Estudio_Group', ),
        'User' => array ( 'local' => 'user', 'foreign' => 'id', 'type' => 'one', 'className' => 'Tecnodesign_Estudio_User', ),
      ),
      'scope' => array (
      ),
      'events' => array (
