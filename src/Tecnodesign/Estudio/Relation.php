 ...
 */
class Tecnodesign_Estudio_Relation extends Tecnodesign_Model
{
    /**
    ...
    public static $schema = array (
      ...
      'relations' => array (
        'Child' => array ( 'local' => 'entry', 'foreign' => 'id', 'type' => 'one', 'className' => 'Tecnodesign_Estudio_Entry', ),
        'Parent' => array ( 'local' => 'parent', 'foreign' => 'id', 'type' => 'one', 'className' => 'Tecnodesign_Estudio_Entry', ),
