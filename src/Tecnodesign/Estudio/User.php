 ...
 */
class Tecnodesign_Estudio_User extends Tecnodesign_Model
{
    /**
    ...
    public static $schema = array (
      ...
      'tableName' => 'tdz_users',
      'label' => '*Users',
      'className' => 'Tecnodesign_Estudio_User',
      'columns' => array (
      ...
      'relations' => array (
        'Credential' => array ( 'local' => 'id', 'foreign' => 'user', 'type' => 'one', 'className' => 'Tecnodesign_Estudio_Credential', ),
      ),
      'scope' => array (
        'string'=>array('name'),
      ),
