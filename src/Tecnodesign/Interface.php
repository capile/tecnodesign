...
class Tecnodesign_Interface extends Studio\Api
{
    ...
    public static
        ...
        $importSuccess      = '%s ―%s― successfully imported.',
        ...
        $importError        = 'It wasn\'t possible to import this data. Please verify the error messages and try again.',
    ...
    public static function run($n=null, $url=null)
    {
        ...
        try {
            ...
            else if(($route=Tecnodesign_App::response('route')) && isset($route['url']) && !preg_match('/[\*\|\(\)]/', $route['url'])) tdz::scriptName($route['url']);
            ...
            } else if($m=Tecnodesign_App::request('extension')) {
                $ext = $m;
            }
            unset($m);
            ...
            if(static::$share) {
                $sf = (static::$share===true || static::$share===1)?('api-shared'):(tdz::slug(static::$share, '_', true));
    ...
    public function redirect($url=null, $oldurl=null)
    {
        ...
        // ajax handlers
        if($oldurl && Tecnodesign_App::request('headers', 'z-action')=='Interface') {
    ...
    public function renderUpdate($o=null, $scope=null)
    {
        ...
        try {
            ...
            $dontpost = (($za=Tecnodesign_App::request('headers', 'z-action')) && in_array($za, array('Upload','choices')));
